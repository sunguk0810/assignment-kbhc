...
public class HealthMeasureConsumer {
    ...
    @Transactional
    public void consume(HealthMeasureEvent event){
        ...
        try {
            ...
            log.error("Error occurred while processing measure log : {}", measureLog, e);
    ...
    private void processEntries(User user, MeasureSaveRequest<? extends HealthDetail> request, HealthMeasureLog measureLog){
        LocalDate measureDate = request.getLastUpdate().toLocalDate();
